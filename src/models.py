...
from transformers.modeling_xlm_roberta import XLMRobertaModel, XLMRobertaForSequenceClassification
...
class XLMRobertaForPromptFinetuning(RobertaForPromptFinetuning):
